...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ImageView=findViewById(R.id.image); //사진 넣을 View
        ...
        public void onClick(View v)
        {
            switch (v.getId())
            {
                ...
                case R.id.leftchoice :
                    Intent intent = new Intent(com.example.myapplication.MainActivity2.this, MainActivity3.class);
                ...
                case R.id.rightchoice :
                    Intent intent2 = new Intent(com.example.myapplication.MainActivity2.this, MainActivity4.class);
