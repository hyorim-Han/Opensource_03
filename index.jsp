...
%>
		...
		<header id="header" class="alt">
			...
			<nav id="nav">
				<ul>
					...
					<li><a href="userLogoutAction.jsp" class="button primary">Logout</a></li>
				</ul>
			</nav>
		</header>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<p class="card-text">아니 겨울쿨톤은 정말 뭘 입고 뭘 찍어발라도 톤그로네요;; 이것저것 추천좀
					해주세요</p>
				<div class="row">
					<div class="col-9 text-left">
				...
				<div class="modal-body">
					<form action="./index2.jsp" method="post">
						...
						<div class="modal-footer">
							<button type="button" class="fit" data-dismiss="modal">취소</button>
							<button type="submit"
								style="background: #83d3c9; border-color: #ffffff; color: #fff"
								class="fit">등록하기</button>
						</div>
					</form>
				</div>
			</div>
