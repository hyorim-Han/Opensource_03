...
<body>
	...
	<section class = "container mt-3" style="max-width:560px;">
		<form method="post" action="./userLoginAction.jsp">
			...
			<button type="submit" style="background: #83d3c9;border-color: #ffffff;color: #fff" class="fit" >로그인</button>
			<button type="button" style="background: #83d3c9;border-color: #ffffff;color: #fff"onclick="location.href='userJoin.jsp' " class="fit">회원가입</button>
		</form>

	</section>	
	<footer class="bg-dark mt-4 p-5 text-center" style="color:#FFFFFF;">
		Copyright &copy; 2020 오픈소스개발프로젝트 03팀
	</footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
